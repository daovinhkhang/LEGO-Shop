...
<body>
	<h1>Levy Flat Registration Form</h1>
		<div class="registration">
			<h2>Registration Form LEGOshop</h2>				
					<form action="{{route('register-process')}}" method="POST">
						...
						<div class="menu_main">
							<a href="login"><i class="btn btn-danger"></i>Login</a>
						 </div>
					    <input type="submit" value="REGISTER">
					</form>
					<ul class="bottom-icons">
						<li><a href="#">SignUp With</a></li>
						<li><a href="#" class="social-login__icon fab fa-facebook"></a></li>
						<li><a href="#" class="social-login__icon fab fa-twitter"></a></li>
						<li><a href="#" class="social-login__icon fab fa-instagram"></a></li>
							<div class="clear"> </div>
					</ul>
							<div class="clear"> </div>
		</div>
