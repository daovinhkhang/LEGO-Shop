      ...
      <div class="header_section">
        <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-sm-4">
               <div class="logo1"><img src="images/logo1.png" alt="" height="300px" width="250px"></div>
            </div>
            <div class="col-sm-4">
               <div class="togle_3">
                  <div class="left_main">
                  ...
                  <div class="right_main">
                     <div class="togle_main"><a class="class="openbtn onclick="openNav()"><img src="images/togle-menu-icon.png" style="max-width: 70%;"></a></div>
                  </div>
               </div>
               </div>
            </div>
         </div>
      <div class="banner-bg layout_padding">
      <div class="container">
      <section >
         <div id="main_slider" class="images/banner-bg.jpg" data-ride="carousel">   
                     ...
                     <div class="row marginii">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="carousel-sporrt_text ">
                              <h1 class="lego_text"><strong style="color: rgb(238, 29, 29);">Lego<br><span style="color: rgb(18, 2, 2);">Shop</span></strong></h1>
                              <p class="lorem_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. 
                                 The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, 
                                 as opposed to using 'Content here, content</p>
                              <button class="buynow_bt">Buy Now</button>
                              <button class="contact_bt">Contact Us</button>
                           </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="images/na.png" style="max-width: 70%;"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="carousel-item">
                  <div class="container">
                     ...
                     <div class="row marginii">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="carousel-sporrt_text ">
                              <h1 class="lego_text"><strong>Lego<br><span style="color: rgb(228, 14, 14);">Shop</span></strong></h1>
                              <p class="lorem_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. 
                                 The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, 
                                 as opposed to using 'Content here, content</p>
                              <button class="buynow_bt">Buy Now</button>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="images/sp.png" style="max-width: 70%;"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row marginii">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="carousel-sporrt_text ">
                              <h1 class="lego_text"><strong>Lego<br><span style="color: rgb(246, 194, 21);">Shop</span></strong></h1>
                              <p class="lorem_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. 
                                 The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, 
                                 as opposed to using 'Content here, content</p>
                              <button class="contact_bt">Buy Now</button>
                              <button class="contact_bt">Contact Us</button>
                           </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="images/gd.png" style="max-width: 70%;"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <div class="our_section_2">
         <div class="our_main">
            <div id="my_slider" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  <p>
                     <img width="800px" src="images/nen.png"
                     style="vertical-align: baseline" alt="images">
                     </p>
               <div class="carousel-item active">
                  <img class="d-block w-100" src="images/na.png" alt="First slide">
               </div>
               <div class="carousel-item">
                  <img class="d-block w-95" src="images/sp.png" alt="Second slide">
               </div>
               <div class="carousel-item">
                 <img class="d-block w-100" src="images/gd.png" alt="Third slide">
               </div>
            </div>
